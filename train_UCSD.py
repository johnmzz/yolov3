...
hyp = {'giou': 1.582,  # giou loss gain
       ...
       'hsv_h': 0.001,  # image HSV-Hue augmentation (fraction)
            ...
            if not (opt.notest or (opt.nosave and epoch < 10)) or final_epoch:
                with torch.no_grad():
                    results, maps = test.test(cfg,
                                              ...
                                              save_json=final_epoch and epoch > 0 and 'coco_person.data' in data)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--rect', action='store_true', help='rectangular training')   # sort image by aspect ratio, group similar images into a batch
